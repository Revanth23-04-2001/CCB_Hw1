"""
EE 5393 Homework 1 - Problem 1(b)
Starting state: [9, 8, 7]
After exactly 7 Gillespie steps, compute:
  - Mean and variance of X1, X2, X3 distributions
"""
...
print("=" * 42)
print(f"{'Species':<10} {'Mean':>12} {'Variance':>14}")
print("-" * 42)
print(f"{'X1':<10} {m1:>12.4f} {v1:>14.4f}")
print(f"{'X2':<10} {m2:>12.4f} {v2:>14.4f}")
print(f"{'X3':<10} {m3:>12.4f} {v3:>14.4f}")
print("=" * 42)
